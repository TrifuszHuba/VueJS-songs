<template>
    <div>
        <select name="artists" id="artists" @change="artistSelected" class="btn btn-primary dropdown-toggle">
            <option value="null">Válassz egy előadót</option>
